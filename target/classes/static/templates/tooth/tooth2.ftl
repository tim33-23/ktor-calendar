...
<div class="container" style="background-image: linear-gradient(to right, rgba(255,255,255,0.4) 0 100%), url('static/fon3.jpg'); height: 100%">
    ...
    <table style="margin-top: 100px">
        <tr>
            <td width="320px"></td>
            <td>
                <div style="width: 60px;height: 60px;margin-top: 120px"><p align="center"><b><br></b></p><input type="image" src="/static/1up.png" alt="Кнопка «1взуб»" style="width: 60px;height: 60px"></div>
            </td>
            <td>
                <div style="width: 60px;height: 60px;margin-top: 60px"><p align="center"><b><br></b></p><input type="image" src="/static/2up.png" alt="Кнопка «2взуб»" style="width: 60px;height: 60px"></div>
            </td>
            <td>
                <div style="width: 60px;height: 60px;margin-top: 30px"><p align="center"><b><br></b></p><input type="image" src="/static/3up.png" alt="Кнопка «3взуб»" style="width: 60px;height: 60px"></div>
            </td>
            <td>
                <div style="width: 60px;height: 60px;margin-top: 5px"><p align="center"><b><br></b></p><input type="image" src="/static/4up.png" alt="Кнопка «4вуб»" style="width: 60px;height: 60px"></div>
            </td>
            <td style="margin-top: 0px">
                <div style="width: 60px;height: 60px;margin-top: 0px"><p align="center"><b><br></b></p><input type="image" src="/static/5up.png" alt="Кнопка «5взуб»" style="width: 60px;height: 60px"></div>
            </td>
            <td style="margin-top: 0px">
                <div style="width: 60px;height: 60px;margin-top: 0px"><p align="center"><b>11м</b></p><input type="image" src="/static/6up.png" alt="Кнопка «6взуб»" style="width: 60px;height: 60px"></div>
            </td>
            <td>
                <div style="width: 60px;height: 60px;margin-top: 5px"><p align="center"><b>8м</b></p><input type="image" src="/static/7up.png" alt="Кнопка «7взуб»" style="width: 60px;height: 60px"></div>
            </td>
            <td>
                <div style="width: 60px;height: 60px;margin-top: 30px"><p align="center"><b><br></b></p><input type="image" src="/static/8up.png" alt="Кнопка «8взуб»" style="width: 60px;height: 60px"></div>
            </td>
            <td>
                <div style="width: 60px;height: 60px;margin-top: 65px"><p align="center"><b><br></b></p><input type="image" src="/static/9up.png" alt="Кнопка «9взуб»" style="width: 60px;height: 60px"></div>
            </td>
            <td>
                <div style="width: 60px;height: 60px;margin-top: 110px"><p align="center"><b><br></b></p><input type="image" src="/static/10up.png" alt="Кнопка «10взуб»" style="width: 60px;height: 60px"></div>
            </td>
            <td></td>
        </tr>
    ...
    <table style="margin-top: 60px">
        <tr>
            ...
            <td width="400px">
                <div>
                    <p style="font-size: 25px;font-family: 'Arial',SansSerif,serif">
                        <b>
                            Название зуба
                        </b>
                    </p>
            ...
            <td width="300px" style="margin-left: 150px">
                <div>
        ...
        <tr>
            <td width="150px"></td>
            <td width="450px" style="margin-left: 150px">
                <div>
                    <p style="font-size: 25px;font-family:'Arial',SansSerif">
            ...
            <td width="200px" style="margin-left: 150px">
                <div>
                    <button type="button" class="btn btn-lg" style="vertical-align: center" >
                        <img src="/static/pen.png" alt="" width="30" height="30">
                    </button>
        ...
        <tr>
            ...
            <td width="450px">
                <div>
                    <p style="font-size: 25px;font-family: 'Arial',SansSerif">
                        Нижний левый центральный резец
                    </p>
                </div>
            </td>
            <td width="300px">
        ...
        <tr>
            ...
            <td width="450px">
                <div>
                    <p style="font-size: 25px;font-family: 'Arial',SansSerif">
                        Верхний левый центральный резец
                    </p>
                </div>
            </td>
            <td width="300px">
    ...
    <div class="container" align="center" style="margin-top: 20px">
        <p class="mt-5 mb-3 text-muted"><br></p>
    </div>
</div>
</body>
</html>